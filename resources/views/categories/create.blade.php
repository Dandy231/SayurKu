<x-app-layout title="Tambah Kategori">
    <div class="container grid px-6 mx-auto">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            <a href="/dashboard/products">{!! __('Category &raquo; Create') !!}</a>
        </h2>
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form class="w-full" action="{{ route('categories.store') }}" method="post" enctype="multipart/form-data">
                ...
                <label class="block text-sm mb-4">
                    ...
                    <input value="{{ old('name') }}" type="text" name="name" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Nama Kategori" />
                </label>
